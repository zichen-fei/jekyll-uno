...
function() {
    ...
    function c(t) {
        ...
        e = Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++) e[i - 1] = arguments[i];
        return s(e,
        function(n) {
            s(n,
            function(n, e) {
    ...
    function L(t) {
        ...
        if (e.width || e.height) {
            var i = {},
            o = null;
            if (null == n || g(n)) o = t.ownerDocument.documentElement,
    ...
    if (Ot) {
        for (var qt = 0; qt < Mt.length && !Tt; ++qt) Tt = _t[Mt[qt] + "RequestAnimationFrame"],
    ...
    Wt = function() {
        ...
        },
        {
            ...
            value: function() {
                ...
                this.options, t), this.header = p(this.options.header), this.bindContainerClick()) : this.isSSR || this.log("Not found scrollable container.")
            }
        },
        {
            key: "destroy",
        ...
        },
        {
            ...
            value: function(t) {
                ...
                else if (l(t)) i.top = n ? t: 0,
                i.left = n ? 0 : t;
                else {
                    if (!e(t)) return null;
                    var r = h(t);
                    if (/^\d+,\d+$/.test(r)) r = r.split(","),
                    i.top = r[0],
                    i.left = r[1];
        ...
        {
            key: "updateURLHash",
            value: function(t, n) { ! this.isSSR && It && n && _t.history["replace" === n ? "replaceState": "pushState"](null, null, t)
            }
        },
        {
            key: "getContainer",
        ...
        },
        {
            ...
            value: function(t) {
                for (var n = this.options,
                e = t.target; e && e !== xt; e = e.parentNode) if (v(e, n.trigger)) {
